...
void bus(cJSON *cell, cJSON *data, cJSON *bus_object)
{
  ...
  cJSON_AddItemToArray(data_bus, cJSON_CreateString(id));
  cJSON_AddItemToArray(data_bus, cJSON_CreateString(name));
  cJSON_AddItemToArray(data_bus, cJSON_CreateString(niveau_tension));
...
void line(cJSON *cell, cJSON *data, cJSON *line_object)
{
  number_line++;
  char *id = cJSON_GetObjectItem(cell, "id")->valuestring;
  char *name = cJSON_GetObjectItem(data, "ligneName")->valuestring;
  char *depart_noeud = cJSON_GetObjectItem(data, "ligneNoeudDepart")->valuestring;
  char *arrive_noeud = cJSON_GetObjectItem(data, "ligneNoeudArrive")->valuestring;
  char *niveau_tension = cJSON_GetObjectItem(data, "ligneNiveauTension")->valuestring;
  char *phase = cJSON_GetObjectItem(data, "lignePhase")->valuestring;
  char *type_line = cJSON_GetObjectItem(data, "ligneTypeLigne")->valuestring;
  ...
  cJSON_AddItemToArray(data_line, cJSON_CreateString(id));
  cJSON_AddItemToArray(data_line, cJSON_CreateString(name));
  cJSON_AddItemToArray(data_line, cJSON_CreateString(depart_noeud));
  cJSON_AddItemToArray(data_line, cJSON_CreateString(arrive_noeud));
  cJSON_AddItemToArray(data_line, cJSON_CreateString(niveau_tension));
  cJSON_AddItemToArray(data_line, cJSON_CreateString(phase));
  cJSON_AddItemToArray(data_line, cJSON_CreateString(type_line));
...
void slack(cJSON *cell, cJSON *data, cJSON *slack_object)
{
  ...
  cJSON_AddItemToArray(data_slack, cJSON_CreateString(id));
  cJSON_AddItemToArray(data_slack, cJSON_CreateString(name));
  cJSON_AddItemToArray(data_slack, cJSON_CreateString(niveau_tension));
  cJSON_AddItemToArray(data_slack, cJSON_CreateString(tension_u));
  cJSON_AddItemToArray(data_slack, cJSON_CreateString(dephasage));
  cJSON_AddItemToArray(data_slack, cJSON_CreateString(phase));
...
void generator(cJSON *cell, cJSON *data, cJSON *generator_object)
{
  ...
  cJSON_AddItemToArray(data_generator, cJSON_CreateString(id));
  cJSON_AddItemToArray(data_generator, cJSON_CreateString(name));
  cJSON_AddItemToArray(data_generator, cJSON_CreateString(source));
  ...
  cJSON_AddItemToArray(data_generator, cJSON_CreateString(resistance_reactance));
  cJSON_AddItemToArray(data_generator, cJSON_CreateString(internal_reactance));
...
void transformer(cJSON *cell, cJSON *data, cJSON *transformer_object)
{
  ...
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(id));
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(name));
  ...
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(niveau_tension));
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(phase));
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(tnp));
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(tns));
  cJSON_AddItemToArray(data_transformer, cJSON_CreateString(pan));
...
void load(cJSON *cell, cJSON *data, cJSON *load_object)
{
  number_load++;
  char *id = cJSON_GetObjectItem(cell, "id")->valuestring;
  char *name = cJSON_GetObjectItem(data, "chargeName")->valuestring;
  // char *name = cJSON_GetObjectItem(data, "chargeName")->valuestring;
  char *niveau_tension = cJSON_GetObjectItem(data, "chargeNiveauTension")->valuestring;
  ...
  cJSON_AddItemToArray(data_load, cJSON_CreateString(id));
  cJSON_AddItemToArray(data_load, cJSON_CreateString(name));
  cJSON_AddItemToArray(data_load, cJSON_CreateString(niveau_tension));
  cJSON_AddItemToArray(data_load, cJSON_CreateString(type));
